...
def create_batches_no_fine_tuning(folder, model=GPT_4_MODEL):
    df = pd.read_csv(f'../datasets/translatediSarcasmEval_ChatGPT4o/train_val_test_split/test_set.csv')
    print(df.head())

    batch_file = open(folder, "w")
...
if __name__ == '__main__':
    # create_batches_no_fine_tuning("./no_fine_tuning_gpt4/test_batch.jsonl", GPT_4_MODEL)
    # create_batches_no_fine_tuning("./no_fine_tuning_gpt3/test_batch.jsonl", GPT_3_MODEL)
    create_batches_no_fine_tuning("./fine_tuning_gpt3/test_batch.jsonl", GPT_3_MODEL_FINE_TUNED)
