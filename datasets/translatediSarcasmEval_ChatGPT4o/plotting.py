...
plt.bar(counts.Value, counts.Frequency)
plt.xlabel("Length")
...
plt.axvline(mean, color="red", linestyle="--", alpha=0.8, label=f"Mean: {mean}")
plt.axvline(median, color="orange", linestyle="--", alpha=0.8, label=f"Median: {median}")
